...
1. [](#bugfix)
    ...
    * Block direct access to `tmp/` in the default Apache rules, including temporary package downloads. Servers that serve static files before Apache must apply the equivalent rule at that layer. [#4316](https://github.com/getgrav/grav/issues/4316)
