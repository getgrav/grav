...
class CleanCommand extends Command
{
    ...
    protected $paths_to_remove = [
        ...
        'vendor/wikimedia/minify/bin',
        'vendor/wikimedia/minify/Makefile',
        'vendor/wikimedia/minify/CHANGELOG.md',
        'vendor/wikimedia/minify/CODE_OF_CONDUCT.md',
        'vendor/wikimedia/minify/README.md',
        'vendor/pear/net_url2/composer.json',
        'vendor/pear/net_url2/docs',
        'vendor/pear/net_url2/README.md',
