...
class CleanCommand extends Command
{
    ...
    protected $paths_to_remove = [
        ...
        'vendor/php-debugbar/php-debugbar/.github',
        'vendor/php-debugbar/php-debugbar/bower.json',
        'vendor/php-debugbar/php-debugbar/composer.json',
        'vendor/php-debugbar/php-debugbar/.bowerrc',
        'vendor/php-debugbar/php-debugbar/src/DebugBar/Resources/vendor',
        'vendor/php-debugbar/php-debugbar/demo',
        'vendor/php-debugbar/php-debugbar/docs',
        'vendor/php-debugbar/php-debugbar/tests',
        'vendor/php-debugbar/php-debugbar/phpunit.xml.dist',
