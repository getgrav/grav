 ...
 */
class ValidationLengthTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testMaxlengthAttributeIsHonouredServerSide(): void
    {
        self::assertFalse(Validation::typeTextarea(str_repeat('a', 101), [], ['maxlength' => 100]));
    }
