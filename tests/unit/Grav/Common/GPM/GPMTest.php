...
class GpmTest extends \Codeception\TestCase\Test
{
    ...
    public function testCheckNextSignificantReleasesAreCompatible()
    {
        ...
        $this->assertTrue($this->gpm->checkNextSignificantReleasesAreCompatible('2.0.0-RC1', '2.0'));
        ...
        $this->assertFalse($this->gpm->checkNextSignificantReleasesAreCompatible('1.0.0-beta1', '2.0'));
