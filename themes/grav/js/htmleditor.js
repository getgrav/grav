...
(function(addon) {
    ...
    UI.component('htmleditor', {
        ...
        defaults: {
            ...
            height       : 500,
            maxsplitsize : 1000,
            markedOptions: { gfm: true, tables: true, breaks: true, pedantic: true, sanitize: false, smartLists: true, smartypan: 'lang-'},
            codemirror   : { mode: 'htmlmixed', theme: 'default', lineWrapping: true, dragDrop: true, autoCloseTags: true, matchTags: true, autoCloseBrackets: true, matchBrackets: true, indentUnit: 4, indentWithTabs: false, tabSize: 4, hintOptions: {completionSingle:false} },
